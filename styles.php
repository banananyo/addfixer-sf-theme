...
.btn-linking {color:<?php echo (!empty($data['link-color'])) ? esc_html($data['link-color']).'!important': ''; ?>; font-weight:bold;}

.btn-linking:hover,

.btn-linking:active,

.btn-linking:focus {text-decoration:underline; color:<?php echo (!empty($data['link-hover-color'])) ? esc_html($data['link-hover-color']).'!important': ''; ?>;}
...
.sf-bnr-text span {
    ...
    font-family: <?php echo (!empty($data['banner-sub-heading-text']['font-family'])) ? esc_html($data['banner-sub-heading-text']['font-family']): ''; ?>;
