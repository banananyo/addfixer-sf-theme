            ...
            <div class="sf-job-info-section">
            	<div class="container">
                    ...
                    <ul class="job-info-list">
                        ...
                        <li class="sf-job-dates"><i class="fa fa-tasks"></i> <?php echo esc_html__( 'Job Status', 'service-finder' ); ?></span> <span><?php echo esc_html(strtoupper($post->post_status)); ?></span></li>
                    </ul>
                    <?php } ?>
                </div>
           </div>
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="padding-20  margin-b-30  bg-white">
                              ...
                              <?php
								...
								?>
                              <h4><?php echo esc_html__( 'Company Description', 'service-finder' ); ?></h4>
                        ...
                        <div class="col-md-4">
                                    ...
                                    <ul>
                                        <li>
                                            <div class="sf-job-customerimage">
                                                ...
                                                <img src="<?php echo esc_url(service_finder_get_avatar_by_userid($post->post_author)); ?>" alt=""> 
                                                <?php } ?>
                                            </div>
                            ...
                            <div class="padding-20  margin-b-30  bg-white">
                                <ul class="job-info-detail">
                                    ...
                                    <li><i class="fa fa-envelope"></i><?php echo get_post_meta(get_the_id(),'_application',true); ?></li>
                                </ul>
