						...
						<?php foreach ( $job_dashboard_columns as $key => $column ) : ?>
							<td class="<?php echo esc_attr( $key ); ?>">
                                ...
                                <?php elseif ('number_of_applicants' === $key ) : ?>
									...
									echo '<a href="javascript:;" class="btn-linking show_applicants" data-jobid="'.esc_attr($job->ID).'">' . service_finder_get_number_of_applicants($job->ID) . '</a>'; 
									}else{
                                ...
                                <?php elseif ('action' === $key ) : ?>
									...
									if($option != ""){
									echo '<select title="'.esc_html__('Select Option', 'service-finder').'" class="jobOptionSelect sf-select-box form-control sf-form-control" data-bid="'.esc_attr($bookingid).'" data-paykey="'.esc_attr($bookingpaypal_paykey).'" data-providerid="'.esc_attr($bookingproviderid).'" data-amount="'.esc_attr($bookingamount).'" >
