    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 col-sm-6 col-xs-6 ">
          ...
          <?php endif; ?>
          <?php }else{ ?>
          <span><?php printf(esc_html__('Copyright %s | Aone Theme. All Rights Reserved','service-finder'),date('Y')); ?></span>
          <?php } ?>
        </div>
        <div class="col-md-6 col-sm-6 col-xs-6">
...
?>
<header id="header-part" class="mostion clearfix <?php echo $class; ?> <?php echo sanitize_html_class($innerheaderclass); ?> <?php echo sanitize_html_class($fullwidth); ?> <?php echo sanitize_html_class($slideposition); ?>">
...
<div class="error notice is-dismissible">
    <p><?php echo $output_deals->error_message; ?></p>
</div>
<?php
}
}
